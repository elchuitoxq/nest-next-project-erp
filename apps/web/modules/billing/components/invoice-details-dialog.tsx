...
export function InvoiceDetailsDialog({
  ...
  const { data: warehouses } = useWarehouses({
    enabled: isVoidDialogOpen && returnStock,
  });
            ...
            <div className="p-6">
              ...
              >
                <ul className="list-disc pl-4 space-y-1">
                  <li>
                    <strong>Emitir:</strong> Asigna correlativo fiscal
                  ...
                  <li>
                    <strong>Nota de Crédito:</strong> Única vía legal para
                    anular una factura ya emitida (Publicada).
                  </li>
                </ul>
              </GuideCard>
                ...
                >
                  <div className="mb-4">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Visión consolidada desde el pedido original hasta los
                      pagos realizados.
                    </p>
                  </div>
                  <DocumentHistory
              ...
              <DialogFooter className="flex flex-col-reverse sm:flex-row gap-2 mt-8 border-t pt-6">
                ...
                {invoice.status !== "VOID" && invoice.status !== "PAID" && (
                  <PermissionsGate
                    permission={PERMISSIONS.FINANCE.INVOICES.VOID}
                  >
                    <Button
                      variant="destructive"
                      onClick={() => {
          ...
          <ScrollArea className="max-h-[85vh] w-full">
            <div className="p-6">
              <DialogHeader>
                ...
                <DialogDescription>
                  ¿Estás seguro que deseas anular esta factura? Esta acción no
                  se puede deshacer.
                </DialogDescription>
              </DialogHeader>
