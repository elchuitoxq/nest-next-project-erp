...
export function WarehousesView() {
  ...
  useEffect(() => {
    if (!hasPermission(PERMISSIONS.INVENTORY.WAREHOUSES.VIEW)) {
  ...
  return (
    <SidebarInset>
      ...
      >
        ...
        >
          <PermissionsGate permission={PERMISSIONS.INVENTORY.WAREHOUSES.CREATE}>
                ...
                >
                  <Card className="flex flex-col justify-between border premium-shadow hover:ring-2 hover:ring-primary/20 transition-all duration-300 group h-full">
                    ...
                    <CardFooter className="flex gap-2 pt-2 border-t bg-muted/5 p-4">
                      <PermissionsGate permission={PERMISSIONS.INVENTORY.VIEW}>
                        <Button
                          variant="outline"
                          size="sm"
                      ...
                      <PermissionsGate
                        permission={PERMISSIONS.INVENTORY.WAREHOUSES.EDIT}
                      >
                        <Button
                          variant="secondary"
                          size="sm"
