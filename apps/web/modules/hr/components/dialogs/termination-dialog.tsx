                  ...
                  <div className="bg-muted p-4 rounded-md space-y-2 mt-4 border border-input">
                    ...
                    <div className="text-sm space-y-1">
                      <div className="flex justify-between">
                        <span>
                          Antigüedad ({calculation.calculation.tenureYears}{" "}
                          años):
                        </span>
                        <span>
                          {formatCurrency(
                            parseFloat(
                              calculation.calculation.accumulatedBenefits,
                            ),
                      ...
                      <div className="flex justify-between">
                        <span>
                          Vacaciones (
                          {calculation.calculation.vacationPending.days} días):
                        </span>
                        <span>
                          {formatCurrency(
                            parseFloat(
                      ...
                      <div className="flex justify-between">
                        <span>
                          Utilidades (
                          {calculation.calculation.profitSharingPending.days}{" "}
                          días):
                        </span>
                        <span>
                          {formatCurrency(
                            parseFloat(
                              calculation.calculation.profitSharingPending
                                .amount,
                            ),
                            calculation.calculation.currency,
                          )}
                      ...
                      {parseFloat(calculation.calculation.doubleIndemnity) >
                        ...
                        <div className="flex justify-between text-red-600 font-medium">
                          ...
                          <span>
                            {formatCurrency(
                              parseFloat(
                                calculation.calculation.doubleIndemnity,
                              ),
                              calculation.calculation.currency,
                            )}
                          </span>
