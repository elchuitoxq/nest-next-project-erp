...
**Personal skills live in agent-specific directories (e.g., `~/.agent/skills` or the project's `.agent/skills` directory).**
...
| ----------------------- | ------------------------------------------------ |
| **Test case**           | Pressure scenario with test agent                |
...
- Project-specific conventions (put in project config files like AI_CONTEXT.md)
...
**Critical for discovery:** Future AI agents need to FIND your skill

### 1. Rich Description Field

**Purpose:** An AI reads the description to decide which skills to load for a given task. Make it answer: "Should I read this skill right now?"
...
**Why this matters:** Testing revealed that when a description summarizes the skill's workflow, AI agents may follow the description instead of reading the full skill content. A description saying "code review between tasks" caused an agent to do ONE review, even though the skill's flowchart clearly showed TWO reviews (spec compliance then code quality).
...
Use words an AI would search for:
...
**Problem:** Frequently-referenced skills load into context often. Every token counts.
...
Always use focused agents (context savings). REQUIRED: Read [other-skill-name] for workflow.
```
...
- ✅ Good: `**REQUIRED SUB-SKILL:** Read test-driven-development skill`
- ✅ Good: `**REQUIRED BACKGROUND:** You MUST read systematic-debugging skill`
...
Skills that enforce discipline (like TDD) need to resist rationalization. AI agents are smart and will find loopholes when under pressure.
...
How a future AI agent finds your skill:
